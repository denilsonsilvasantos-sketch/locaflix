...
export type CancellationPolicy = 'LEVE' | 'MODERADO' | 'FIRME'
...
export type PeriodType = 'WEEKDAY' | 'WEEKEND' | 'CUSTOM' | 'HOLIDAY' | 'LOW_SEASON' | 'HIGH_SEASON' | 'CHRISTMAS_NEW_YEAR' | 'CARNIVAL' | 'CHRISTMAS' | 'NEW_YEAR'
